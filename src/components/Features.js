...
export const Features = ({ searchCountry, searchHandler, clickHandler, paramsRegions }) => {
  ...
  return (
    <div id="features " className="flex  lg:justify-between flex-wrap lg:flex-nowrap">
      ...
      <details id="region-list" className=" mt-14 lg:mt-0  w-3/6 lg:w-1/6 bg-very-light-gray hover:cursor-pointer shadow rounded  relative">
